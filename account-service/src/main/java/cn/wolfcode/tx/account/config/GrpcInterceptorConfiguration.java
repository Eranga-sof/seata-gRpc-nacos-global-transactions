package cn.wolfcode.tx.account.config;


import cn.wolfcode.tx.account.intercepter.ClientTransactionGrpcInterceptor;
import cn.wolfcode.tx.account.intercepter.ServerTransactionGrpcInterceptor;
